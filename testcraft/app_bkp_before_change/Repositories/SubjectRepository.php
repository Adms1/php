...
class SubjectRepository
{
    ...
    {
        try {
            // return CourseSubjectTopic::with(['subject' => function($query) {
            //                 $query->orderBy('SubjectName');
            //             }])
            //             ->where('CourseID', $course_id)
            //             ->where('IsActive', 1)
            //             ->distinct('SubjectID', 'SubjectName')
            //             ->get()
    ...
    {
        try {
            // return BoardStandardSubjectChapterTopic::with(['subject' => function($query) {
            //                 $query->orderBy('SubjectName');
            //             }])
