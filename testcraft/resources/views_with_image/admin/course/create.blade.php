...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['courses.store'], 'enctype' => 'multipart/form-data', 'data-parsley-validate']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('CourseName', old('CourseName'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('CourseTypeID', $course_types, null, ['class' => 'form-control', 'required' => '']) !!}
