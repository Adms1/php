                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 form-group test-type">
                                            ...
                                            {!! Form::select('TypeID', [], null,['class' => 'form-control', 'id' => 'type_id','placeholder' => 'Please Select Test Type', 'required' => '', 'data-parsley-errors-container' => '#type_id_error']) !!}
            ...
            <div class="modal fade" id="deleteAssinged" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header thead-color">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">{{trans('admin.ca_delete_assign_ct')}}</h4>
                        </div>
                        <div class="modal-body">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success) {
                        ...
                        '<img src="{{ Config::get('settings.QUESTION_IMAGE_URL') }}"/>'
                        $('#que_header').html(data.question.question_type.QuestionTypeName);
                        var img = "{{ Config::get('settings.QUESTION_IMAGE_URL').':slug' }}";
                        var src = img.replace(':slug', data.question.QuestionImage);
                        $('#que_name').html('<img src="'+src+'"/>');
