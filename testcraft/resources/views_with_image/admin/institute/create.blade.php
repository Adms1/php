...
@section('content')
    <h3 class="page-title">@lang('admin.institutes.title')</h3>
    
    {!! Form::open(['method' => 'POST', 'route' => ['institutes.store'], 'enctype' => 'multipart/form-data', 'data-parsley-validate']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('InstituteName', old('InstituteName'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                ...
                <div class="col-xs-6 form-group">
                    {!! Form::label('IsActive', trans('admin.institutes.fields.is-active'), ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    {!! Form::label('photo', trans('admin.institutes.fields.photo'), ['class' => 'control-label']) !!}
    ...
    <a href="{{ route('institutes.index') }}" class="btn btn-info">@lang('admin.ca_cancel')</a>
    {!! Form::close() !!}
@stop
