...
@section('content')
	...
	{!! Form::open(['method' => 'PATCH', 'route' => ['change_password'], 'data-parsley-validate']) !!}
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-xs-12 form-group">
					...
					{!! Form::password('new_password_confirmation', ['class' => 'form-control', 'placeholder' => '', 'required', 'data-parsley-equalto' => '#new_password', 'data-parsley-equalto-message'=>'Not same as New password']) !!}
					<p class="help-block"></p>
