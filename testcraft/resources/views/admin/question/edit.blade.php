        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('BoardID', $boards, $board_id, ['id'=>'board_id', 'class' => 'form-control board', 'placeholder' => 'Please Select Board', 'required' => '']) !!}
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('StandardID', $standards, $standard_id, ['id'=>'standard_id', 'class' => 'form-control standard', 'placeholder' => 'Please Select Standard', 'required' => '']) !!}
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('SubjectID', $subjects, $subject_id, ['id'=>'subject_id', 'class' => 'form-control subject', 'placeholder' => 'Please Select Subject', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('ChapterID', $chapters, $chapter_id, ['id'=>'chapter_id', 'class' => 'form-control chapter', 'placeholder' => 'Please Select Chapter', 'required' => '']) !!}
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('TopicID', $topics, $topic_id, ['id'=>'topic_id', 'class' => 'form-control topic', 'placeholder' => 'Please Select Topic', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('Marks', $question->Marks or old('Marks'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-label" >
                            {!! Form::radio('QuestionTypeID', $question_type->QuestionTypeID, ($question->QuestionTypeID == $question_type->QuestionTypeID) ? true : false, ['class' => '', 'required' => 'required']) !!}
