        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-4 form-group academic">
                    ...
                    {!! Form::select('BoardID', $boards, null,['id'=>'board_id', 'class' => 'form-control board', 'placeholder' => 'Please Select Board', 'required' => '', 'data-parsley-errors-container' => '#board_id_error']) !!}
                ...
                <div class="col-xs-4 form-group academic">
                    ...
                    {!! Form::select('StandardID', [], null,['id'=>'standard_id', 'class' => 'form-control standard', 'placeholder' => 'Please Select Standard', 'required' => '', 'data-parsley-errors-container' => '#standard_id_error']) !!}
                ...
                <div class="col-xs-4 form-group competitive">
                    ...
                    {!! Form::select('CourseID', $courses, null,['id'=>'course_id', 'class' => 'form-control', 'placeholder' => 'Please Select Course', 'required' => '', 'data-parsley-errors-container' => '#course_id_error']) !!}
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::select('SubjectID', [], null,['id'=>'subject_id', 'class' => 'form-control subject', 'placeholder' => 'Please Select Subject', 'required' => '', 'data-parsley-errors-container' => '#subject_id_error']) !!}
            ...
            <div class="row">
                <div class="col-xs-6 form-group academic">
                    ...
                    {!! Form::select('ChapterID', [], null,['id'=>'chapter_id', 'class' => 'form-control chapter', 'placeholder' => 'Please Select Chapter', 'required' => '', 'data-parsley-errors-container' => '#chapter_id_error']) !!}
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('TopicID', [], null,['id'=>'topic_id', 'class' => 'form-control topic', 'placeholder' => 'Please Select Topic', 'required' => '', 'data-parsley-errors-container' => '#topic_id_error']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-label" >
                            {!! Form::radio('QuestionTypeID', $question_type->QuestionTypeID, false, ['class' => '', 'required' => 'required', 'data-parsley-errors-container' => '#question_type_error']) !!}
