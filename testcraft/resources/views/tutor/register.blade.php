                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('tutors.store') }}" data-parsley-validate>
                        ...
                        <div class="form-group row">
                            <label for="TutorName" class="col-md-4 col-form-label"><b>{{ trans('admin.tutors.fields.name') }}<span class="help-block">*</span></b></label>
                        ...
                        <div class="form-group row">
                            <label for="TutorEmail" class="col-md-4 col-form-label"><b>{{ trans('admin.tutors.fields.email')}}<span class="help-block">*</span></b></label>
                        ...
                        <div class="form-group row">
                            <label for="TutorPhoneNumber" class="col-md-4 col-form-label"><b>{{ trans('admin.tutors.fields.phone')}}<span class="help-block">*</span></b></label>
                        ...
                        <div class="form-group row">
                            <label for="TutorPassword" class="col-md-4 col-form-label"><b>{{trans('admin.tutors.fields.password') }}<span class="help-block">*</span></b></label>
                        ...
                        <div class="form-group row">
                            <label for="TutorPassword_confirmation" class="col-md-4 col-form-label"><b>{{ __('Confirm Password') }}<span class="help-block">*</span></b></label>
