...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['courseTypes.store'], 'enctype' => 'multipart/form-data', 'data-parsley-validate']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('CourseTypeName', old('CourseTypeName'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
