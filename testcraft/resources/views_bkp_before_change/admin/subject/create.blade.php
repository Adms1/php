...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['subjects.store'], 'enctype' => 'multipart/form-data', 'data-parsley-validate']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('SubjectName', old('SubjectName'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
