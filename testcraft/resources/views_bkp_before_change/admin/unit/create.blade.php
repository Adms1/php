...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['units.store'], 'enctype' => 'multipart/form-data', 'data-parsley-validate']) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('UnitName', old('UnitName'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('ChapterID[]', [], null,['id'=>'chapter_id', 'class' => 'form-control', 'required' => '', 'multiple']) !!}
