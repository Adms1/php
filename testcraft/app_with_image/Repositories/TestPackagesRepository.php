...
/*            echo $total_tests;
    ...
    /*            print_r($data->toArray());
            ...
            $questions = $questions->select(DB::raw('count("QuestionTypeID") as total, QuestionTypeID'))
    ...
    {
        try {             
            return TestSection::with(['questionTypes.questionType', 'questionTypes.testQuestion.question'])
                        ->has('questionTypes')
    ...
    {
        try {             
            return TestSubjectTopic::where('TestPackageTestID', $test_id)->get();
        } catch (\Exception $e) {
            Log::channel('loginfo')
