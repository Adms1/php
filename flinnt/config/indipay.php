...
return [
    ...
    */
    ...
    'ccavenue' => [                         // CCAvenue Parameters
        'merchantId'  => env('INDIPAY_MERCHANT_ID', '6645'),
        'accessCode'  => env('INDIPAY_ACCESS_CODE', 'AVIA02GA51CN72AINC'),
        'workingKey' => env('INDIPAY_WORKING_KEY', '0DE3631856F0A7A211E4E26B1CA3E776'),

        // Should be route address for url() function
        'redirectUrl' => env('INDIPAY_REDIRECT_URL', 'order/checkout/response'),
        'cancelUrl' => env('INDIPAY_CANCEL_URL', 'order/checkout/response'),
