            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                  ...
                  <?php echo Form::open(['route'=>['product_update', $id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'product-form', 'enctype'=>'multipart/form-data']); ?>

                  <ul id="product_tabs" class="nav nav-tabs bar_tabs" role="tablist">
                    <li role="presentation" class="<?php echo e(empty($product->tab) ? 'active' : ''); ?>"><a href="#product_info" id="product_info_tab" role="tab" data-toggle="tab" aria-expanded="true">Basic Info</a>
                    </li>
                    ...
                    <?php if($product->product_type == 'book'): ?>
                      <li role="presentation" class="product_book  <?php echo e($product->tab); ?> <?php echo e(!empty($product->tab) && $product->tab == 'product_images' ? 'active' : 'sdasdasdasdasdasdasdasdasd'); ?>"><a href="#product_images" role="tab" id="product_images_tab" data-toggle="tab" aria-expanded="false">Images</a>
                      </li>
                  ...
                  <div id="product_tab_content" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade <?php echo e(empty($product->tab) ? 'active in' : ''); ?>" id="product_info" aria-labelledby="product_info_tab">
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label for="product_type">Product Type <span class="required">*</span></label>
                          <div class="form-group">
                            <?php echo Form::radio('product_type','book', $product->product_type == 'book', ['class' => 'flat']); ?>

                            <label class="form-label" >&nbsp; Book &nbsp;</label>
                            <!-- <label class="form-label">&nbsp; Other &nbsp;</label>
                            <?php echo Form::radio('product_type','other', $product->product_type == 'other'); ?> -->
                          </div>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('name', $product->book_name, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Product Name', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                              ...
                              <?php echo Form::select('publisher_id',$publishers, $product->publisher_id, ['class'=>'form-control', 'required'=>'required', 'id' => 'publisher_id', 'data-parsley-errors-container' => '#publisher_id_error']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            <?php echo Form::select('author_id[]',$authors, $product->author, ['class'=>'form-control', 'required'=>'required', 'id' => 'author_id', 'multiple', 'data-parsley-errors-container' => '#author_id_error']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            <?php echo Form::text('year', $product->series, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Edition year', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            <?php echo Form::text('isbn', $product->isbn, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter ISBN Number', 'required'=>'required']); ?>

                            <span class="text-danger"><?php echo e($errors->first('isbn')); ?></span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            <label for="name">Paper Back <span class="required">*</span></label>
                            <?php echo Form::select('format',$formats, $product->format, ['class'=>'form-control', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            <?php echo Form::select('language_id',$languages, $product->language_id, ['class'=>'form-control', 'placeholder'=>'Select Language', 'required'=>'required']); ?>
                      ...
                      <div class="form-group product_book">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::checkbox('is_academic', old('is_academic'), ($product->is_academic == 1) ? true : false, ['class'=>'js-switch', 'id'=>'is_academic']); ?>
                      ...
                      <div class="form-group product_book academic">
                        <div class="form-group">
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              ...
                              <?php echo Form::select('board_id[]', $board, $product->board, ['class'=>'form-control academic_book col-md-7 col-xs-12', 'multiple'=>'multiple', 'id' => 'board_id', 'required'=>'required', 'data-parsley-errors-container' => '#board_id_error']); ?>

                              <span id="board_id_error" class="text-danger"><?php echo e($errors->first('board_id')); ?></span>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              <label for="standard_id">Standard</label>
                              <?php echo Form::select('standard_id[]',$class, $product->standard, ['class'=>'form-control academic_book', 'multiple'=>'multiple', 'id' => 'standard_id', 'required'=>'required', 'data-parsley-errors-container' => '#standard_id_error']); ?>

                              <span id="standard_id_error" class="text-danger"><?php echo e($errors->first('standard_id')); ?></span>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              <label for="subject_id">Subject</label>
                              <?php echo Form::select('subject_id',$subject, $product->subject_id, ['class'=>'form-control academic_book', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md4 col-sm-4 col-xs-12">
                            ...
                            <?php echo Form::number('list_price', $product->list_price, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter List Price', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <?php echo Form::number('display_price', $product->display_price, ['class'=>'form-control', 'placeholder'=>'Enter Display Price', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php echo Form::text('hs_code', $product->hs_code, ['class'=>'form-control', 'required'=>'required', 'placeholder' => 'Enter Code']); ?>
...
<!--                       <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::text('description[]', (isset($product->description[0]) ? $product->description[0] : null), ['class'=>'form-control', 'placeholder'=>'Enter Single Description', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::textarea('description[]', (isset($product->description[1]) ? $product->description[1] : null), ['class'=>'form-control']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::checkbox('is_active', old('is_active'), ($product->is_active == 1) ? true : false, ['class'=>'js-switch', 'id'=>'is_active']); ?>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="product_categories_info" aria-labelledby="product_categories_info_tab">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" id="select_category_css">
                            <?php echo Form::select('category_id[]', $categories, $product->category_tree, ['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'id'=>'category_id', 'multiple'=>'multiple', 'data-parsley-errors-container' => '#category_id_error']); ?>
...
<!--                         <div class="form-group">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="product_attribute_info" aria-labelledby="product_attribute_info_tab">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <?php echo Form::select('attribute_id', $attributes, null, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Select Attribute', 'id'=>'attribute_id']); ?>

                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <?php echo Form::text('attribute_val', old('attribute_val'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter attribute value', 'id'=>'attribute_val']); ?>
                      ...
                      <table id="tabel_sp_atr" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                        ...
                        <tbody class="sp_atr row_position">
                          <?php $__currentLoopData = $product->attribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr class="mul_div">
                            <td>
                              <input name="book_attribute_id" type="hidden" value="<?php echo e($attribute->book_attribute_id); ?>">
                              <?php echo e($attribute->attribute_name); ?></td>
                    ...
                    <!-- <div role="tabpanel" class="tab-pane fade" id="product_tag" aria-labelledby="product_tag_tab">
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <label>Tags</label>
                          <?php echo Form::text('tag', 'social, adverts', ['id' => 'tags', 'class'=>'tags form-control']); ?>
                      ...
                      <table id="tabel_sp_atr" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                        ...
                        <tbody class="sp_atr row_position">
                          <tr class="mul_div">
                            ...
                            <td>M, S</td>
                            <td>659</td>
                            <td><img class="width-20" src="<?php echo e(URL::asset('/images/tshirt.jpg')); ?>"></td>
                            <td>
                          ...
                          <tr class="mul_div">
                            ...
                            <td>32 inches</td>
                            <td>11999</td>
                            <td><img class="width-20" src="<?php echo e(URL::asset('/images/tt.jpg')); ?>"></td>
                            <td>
                              <a class="btn btn-danger remove_this">Delete</a>
                            </td>
                          </tr>
                          ...
                          <tr class="mul_div">
                            ...
                            <td>M, S</td>
                            <td>659</td>
                            <td><img class="width-20" src="<?php echo e(URL::asset('/images/shirt.jpg')); ?>"></td>
                            <td>
                              <a class="btn btn-danger remove_this">Delete</a>
                            </td>
                          </tr>
                    ...
                    <div role="tabpanel" class="tab-pane fade <?php echo e(!empty($product->tab) && $product->tab == 'product_images' ? 'active in' : ''); ?>" id="product_images" aria-labelledby="product_images_tab">
                      <div class="form-group">
                        <label for="primary_image" class="control-label col-md-3 col-sm-3 col-xs-12">Front Image <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo Form::file('primary_image', ['id'=>'pr_primary_image', 'onchange' => 'handleFileSelect()']); ?>

                            <span class="text-danger"><?php echo e($errors->first('primary_image')); ?></span>
                      ...
                      <div class="form-group">
                        ...
                        <output id="result">
                          ...
                          <?php echo e(URL::asset('/'.Config::get('settings.THUMBNAIL_PRODUCT_IMG_PATH').$product->primary_image)); ?>">
                        <output/>
                      </div>
                      <div class="form-group">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      var manualuploader = new qq.FineUploader({
            ...
            request: {
              endpoint: '<?php echo e(route("product_update", $id)); ?>',
              params: {'_token': csrf_token},
              inputName: 'listing'
                //endpoint: '<?php echo e(asset("vendors/fine_upload/endpoint.php")); ?>'
            },
            deleteFile: {
              enabled: true,
              forceConfirm: true,
              params: {'_token': csrf_token},
              endpoint: '<?php echo e(route("product_deleteImage", $id)); ?>'
              //endpoint: '<?php echo e(asset("vendors/fine_upload/endpoint.php")); ?>'
            },
            session: {
              endpoint: '<?php echo e(route("product_getImage", $id)); ?>',
              refreshOnRequest:true
            },
            thumbnails: {
              placeholders: {
                  waitingPath: '<?php echo e(asset("vendors/fine_upload/placeholders/waiting-generic.png")); ?>',
                  notAvailablePath: '<?php echo e(asset("vendors/fine_upload/placeholders/not_available-generic.png")); ?>'
              }
            },
            resume: {
              enabled: true
        ...
        new qq.FineUploader({
            ...
            request: {
              endpoint: '<?php echo e(route("product_store")); ?>',
              params: {'_token': csrf_token},
              inputName: 'listing'
                //endpoint: '<?php echo e(asset("vendors/fine_upload/endpoint.php")); ?>'
            },
        ...
        jQuery(document).on('click', '#add_sp_attr', function() {
          ...
          $.ajax({
            url:"<?php echo e(route('attribute_ajaxstore', $id)); ?>",
            type:'POST',
            data:formData,
    ...
    $(document).ready(function(){
          ...
          var input = $(this).parents("tr").find('input[type="text"]');
              ...
              if(!empty){
                input.each(function(){
                  ...
                  $.ajax({
                    url:"<?php echo e(route('attribute_ajaxupdate')); ?>",
                    type:'POST',
                    dataType: 'json',
        ...
        $(document).on("click", ".delete", function(){
            ...
            $.ajax({
              url:"<?php echo e(route('attribute_ajaxdelete')); ?>",
              type:'POST',
              dataType: 'json',
