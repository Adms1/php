          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php echo Form::open(['route'=>'institution_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'institution-form', 'enctype'=>'multipart/form-data']); ?>

                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="name">Institution Name <span class="required">*</span></label>
                        <?php echo Form::text('institution_name', old('institution_name'), ['class'=>'form-control', 'placeholder'=>'Enter Name', 'required'=>'required']); ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::text('contact_name', old('contact_name'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter contact name', 'required'=>'required']); ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::text('address1', old('address1'), ['class'=>'form-control', 'placeholder'=>'Enter Address1', 'required'=>'required']); ?>

                        <span class="text-danger"><?php echo e($errors->first('address1')); ?></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="address2">Address2 <span class="required">*</span></label>
                        <?php echo Form::text('address2', old('address2'), ['class'=>'form-control', 'placeholder'=>'Enter Address2']); ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::text('city', old('city'), ['class'=>'form-control', 'placeholder'=>'Enter City', 'required'=>'required']); ?>

                        <span class="text-danger"><?php echo e($errors->first('city')); ?></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <label for="state_id">State <span class="required">*</span></label>
                      <?php echo Form::select('state_id',$states, old('state_id'), ['class'=>'form-control', 'placeholder'=>'Select State', 'id'=>'state_id', 'required'=>'required']); ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::text('pin', old('pin'), ['class'=>'form-control', 'placeholder'=>'Enter Pin', 'required'=>'required']); ?>

                        <span class="text-danger"><?php echo e($errors->first('pin')); ?></span>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="country_id">Country <span class="required">*</span></label>
                        <?php echo Form::select('country_id',$countries, old('country_id'), ['class'=>'form-control', 'placeholder'=>'Select Country', 'required'=>'required']); ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::text('phone', old('phone'), ['class'=>'form-control', 'placeholder'=>'Enter Phone', 'required'=>'required', 'data-parsley-pattern' => '^[\d\+\-\.\(\)\/\s]*$']); ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::file('institution_image', ['id'=>'photo', 'onchange' => 'handleFileSelect()', 'required'=>'required']); ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php echo Form::select('status_id',$status, old('status_id'), ['class'=>'form-control', 'placeholder'=>'Select status', 'required'=>'required']); ?>
