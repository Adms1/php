                ...
                <div class="x_content">
                  <br />
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <button class="btn btn-info float-right" onclick="window.location='<?php echo e(route("standards")); ?>'">Add Standard</button>
                    </div>
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo e($i++); ?></td>
                        <td><a href='<?php echo e(route("standard_edit", [$standard->standard_id])); ?>' class="tabel_link"><?php echo e($standard->standard_name); ?></a></td>
                        <td>
                          <a href='<?php echo e(route("standard_destroy", [$standard->standard_id])); ?>' class="btn btn-danger btn-xs standard-delete"><i class="fa fa-close"></i> Delete </a>
                        </td>
                      </tr>
