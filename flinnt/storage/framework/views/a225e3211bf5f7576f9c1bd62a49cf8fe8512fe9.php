          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php endif; ?>
                <?php echo Form::open(['route'=>'atr_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'product-form']); ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="pr_attr_info_tab" aria-labelledby="info-tab">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php echo Form::text('attribute_value', 'Color', ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Value', 'required'=>'required']); ?>

                                <span class="text-danger"><?php echo e($errors->first('attribute_value')); ?></span>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <?php echo Form::textarea('description', 'This is a edit color page', ['class'=>'form-control', 'placeholder'=>'Enter Description', 'required'=>'required']); ?>
