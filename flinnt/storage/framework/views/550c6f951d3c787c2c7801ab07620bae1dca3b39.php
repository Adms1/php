        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <?php endif; ?>
                    <?php echo Form::open(['route'=>'vendor_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'vendor-form', 'enctype'=>'multipart/form-data']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_name', old('vendor_name'), ['class'=>'form-control', 'placeholder'=>'Enter Name', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_gst_number', old('vendor_gst_number'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter GST', 'required'=>'required']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_address1', old('vendor_address1'), ['class'=>'form-control', 'placeholder'=>'Enter Address1', 'required'=>'required']); ?>

                            <span class="text-danger"><?php echo e($errors->first('vendor_address1')); ?></span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="vendor_address2">Address2</label>
                            <?php echo Form::text('vendor_address2', old('vendor_address2'), ['class'=>'form-control', 'placeholder'=>'Enter Address2']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_city', old('vendor_city'), ['class'=>'form-control', 'placeholder'=>'Enter City', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::select('vendor_state_id',$states, old('vendor_state_id'), ['class'=>'form-control', 'placeholder'=>'Select State', 'id'=>'vendor_state_id', 'required'=>'required', 'data-parsley-errors-container' => '#vendor_state_id_error']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_pin', old('vendor_pin'), ['class'=>'form-control', 'placeholder'=>'Enter Pin', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::select('vendor_country_id',$countries, old('vendor_country_id'), ['class'=>'form-control', 'placeholder'=>'Select Country', 'required'=>'required']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::email('email', old('email'), ['class'=>'form-control', 'placeholder'=>'Enter Email', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('vendor_phone', old('vendor_phone'), ['class'=>'form-control', 'placeholder'=>'Enter Phone', 'required'=>'required', 'data-parsley-pattern' => '^[\d\+\-\.\(\)\/\s]*$']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::select('vendor_status_id',$status, old('vendor_status_id'), ['class'=>'form-control', 'placeholder'=>'Select Vendor status', 'required'=>'required']); ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('flint_charge', 5, ['class'=>'form-control', 'placeholder'=>'Enter service charge', 'required'=>'required']); ?>
