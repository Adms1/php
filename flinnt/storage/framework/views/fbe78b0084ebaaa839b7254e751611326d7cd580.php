          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php echo Form::open(['route'=> ["board_update", $board->board_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'board-form']); ?>

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="attribute_type">Board Name</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo Form::text('board_name', $board->board_name, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter board name', 'required'=>'required']); ?>
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <?php echo Form::textarea('about_board', $board->about_board, ['class'=>'form-control', 'placeholder'=>'About Board', 'required'=>'required']); ?>
