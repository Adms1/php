          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php echo Form::open(['route'=>'author_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'author-form']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo Form::text('author_name', old('author_name'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter author name', 'required'=>'required']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <?php echo Form::textarea('about_author', old('about_author'), ['class'=>'form-control', 'placeholder'=>'About Author']); ?>
