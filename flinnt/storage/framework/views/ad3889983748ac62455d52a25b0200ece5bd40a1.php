...
<!--===============================================================================================-->
    <link href="<?php echo e(asset('fonts/themify/themify-icons.css')); ?>" rel="stylesheet">
<!--===============================================================================================-->
    <link href="<?php echo e(asset('fonts/Linearicons-Free-v1.0.0/icon-font.min.css')); ?>" rel="stylesheet">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
    <link href="<?php echo e(asset('vendors/css-hamburgers/hamburgers.min.css')); ?>" rel="stylesheet">
<!--===============================================================================================-->
...
<!--===============================================================================================-->
    <link href="<?php echo e(asset('vendors/noui/nouislider.min.css')); ?>" rel="stylesheet">
<!--===============================================================================================-->
        ...
        <div class="container-menu-header">
            ...
            <div class="wrap_header">
                ...
                <div class="header-icons">
                    <!-- <img src="<?php echo e(asset('images/icons/icon-header-01.png')); ?>" class="header-icon1 dropdown" alt="ICON">
                    <div class="header-cart dropdown-content">
                        <ul class="header-cart-wrapitem">
                            <li class="header-cart-item">
                                <a href="<?php echo e(route('user_profile')); ?>"><i class="fa fa fa-user"> </i> Profile</a>
                            </li>
                            <li class="header-cart-item">
                                <a href="<?php echo e(route('user_order')); ?>"><i class="fa fa fa-wpforms"> </i> Order List</a>
                            </li>
                            <li class="header-cart-item">
                                <a href="<?php echo e(route('user_logout')); ?>"><i class="fa fa fa-sign-out"> </i> Logout</a>
                            </li>
                        </ul>
                    </div> -->
                    ...
                    <div class="dropdown">
                      <button class="dropbtn">Hi, <?php echo e(Auth::guard('user')->user()->user_name); ?>
                    ...
                    <a href="<?php echo e(route('front_home')); ?>" class="header-wrapicon1 dis-block">
                        <img src="<?php echo e(asset('images/icons/home.png')); ?>" class="header-icon1" alt="ICON">
                    ...
                    <a href="#" class="header-wrapicon1 dis-block">
                        <img src="<?php echo e(asset('images/icons/flinnt_book_final.png')); ?>" class="header-icon1" alt="ICON">
                    ...
                    <div class="shopping-cart-header">
                        <div class="header-wrapicon2">
                            ...
                            <?php if(Auth::guard('user')->check()): ?> 
                                <?php echo e(Cart::instance('cartlist')->count()); ?>
                            ...
                            <div class="header-cart header-dropdown">
                                <ul class="header-cart-wrapitem">
                                    <?php $__currentLoopData = Cart::instance('cartlist')->content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="header-cart-item">
                                        <div class="header-cart-item-img">
                                            <img src="<?php echo e(URL::asset('/'.$cart->options->image)); ?>" alt="IMG">
                                        </div>
                                        ...
                                        <div class="header-cart-item-txt">
                                            ...
                                            <span class="header-cart-item-info m-text14">
                                                <?php echo e($cart->qty); ?> x <i class="fa fa-rupee"></i> <?php echo e($cart->price); ?>
                                ...
                                <div class="header-cart-total m-text14">
                                    Total: <i class="fa fa-rupee"></i> <?php echo e(Cart::subtotal()); ?>
                                ...
                                <div class="header-cart-buttons">
                                    <div class="header-cart-wrapbtn">
                                        <!-- Button -->
                                        <a href="<?php echo e(url('/cart')); ?>" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
                                            View Cart
                                        </a>
                                    </div>

                                    <?php if(Cart::instance('cartlist')->count() > 0): ?>
                                    <div class="header-cart-wrapbtn">
                                        <!-- Button -->
                                        <a href="<?php echo e(route('select_address')); ?>" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
                                            Check Out
                                        </a>
                                    </div>
                                    <?php endif; ?>
                ...
                <?php else: ?>
                <div class="header-icons">
                    <a href="<?php echo e(Config::get('settings.APP_URL')); ?>" class="btn flinnt-btn border-white">Login</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="wrap_header_mobile wrap_header">
            ...
            <div class="btn-show-menu">
                ...
                <div class="header-icons-mobile">
                    ...
                    <div class="dropdown">
                        <img src="<?php echo e(asset('images/icons/icon-header-01.png')); ?>" class="header-icon1 dropbtn" alt="ICON">
                        <div class="dropdown-content">
                            <a href="#">Hi, <?php echo e(Auth::guard('user')->user()->user_name); ?></a>
                            <a href="<?php echo e(route('user_profile')); ?>"><i class="fa fa fa-user"> </i> Profile</a>
                            <a href="<?php echo e(route('user_order')); ?>"><i class="fa fa fa-wpforms"> </i> Order List</a>
                            <a href="<?php echo e(route('user_logout')); ?>"><i class="fa fa fa-sign-out"> </i> Logout</a>
                        </div>
                    ...
                    <div class="shopping-cart-header">
                        <div class="header-wrapicon2">
                            <img src="<?php echo e(asset('images/icons/icon-header-02.png')); ?>" class="header-icon1 js-show-header-dropdown" alt="ICON">
                            <span class="header-icons-noti bg-color"><?php echo e(Cart::instance('cartlist')->count()); ?></span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <p><?php echo e('Please select institution and update your profile first.'); ?></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" id="notification_close" data-dismiss="modal">Close</button>
                    <button type="button" onclick="location.href = '<?php echo e(route("user_profile")); ?>'" id="notification_submit" class="btn btn-primary">Update Now</button>
                </div>
            </div>
        </div>
    </div>
...
<!--===============================================================================================-->
    <script src="<?php echo e(asset('vendors/daterangepicker/moment.min.js')); ?>"></script>
...
<!--===============================================================================================-->
    <script src="<?php echo e(asset('vendors/noui/nouislider.min.js')); ?>"></script>
    <script type="text/javascript">
        /*[ No ui ]
        ===========================================================*/
