              ...
              <tbody>
                <?php $__currentLoopData = $booksets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="">
                    ...
                    <td><?php echo e($bookset->book_set_name); ?></td>
                    <td><?php echo e($bookset->ibsbookset->ibs->institution->institution_name); ?></td>
                    ...
                    <td><a class="booklist" bookset_id="<?php echo e($bookset->book_set_id); ?>" href="#" data-toggle="modal" data-target=".view-books">View</a></td>
                    <td><?php echo e($bookset->bookset_price); ?></td>
                  </tr>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <?php echo Form::open(['route'=>['bookset_vendorprice'], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'vendor-price-form']); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
              <?php echo Form::hidden('list_price', old('list_price'), ['id' => 'list_price']); ?>

              <?php echo Form::text('sale_price', old('sale_price'), ['id' => 'sale_price', 'class'=>'form-control', 'placeholder'=>'Enter price', 'style' => 'text-align: right;']); ?>

              <?php echo Form::hidden('book_set_id', old('book_set_id'), ['id' => 'book_set_id', 'class'=>'form-control']); ?>

              <?php echo Form::hidden('institution_id', old('institution_id'), ['id' => 'institution_id', 'class'=>'form-control']); ?>
