        ...
        <div class="x_panel">
          ...
          <div class="x_content">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <button class="btn btn-info float-right" onclick="window.location='<?php echo e(route("vendors")); ?>'">Add Vendor</button>
                </div>
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($i++); ?></td>
                        <td><a href='<?php echo e(route("vendor_edit", $vendor->vendor_id)); ?>' class="tabel_link"><?php echo e($vendor->vendor_name); ?></a></td>
                        ...
                        <td><?php echo e($vendor->status->status_name); ?></td>
                        <td>
                            <a href='<?php echo e(route("vendor_destroy", [$vendor->vendor_id])); ?>' class="btn btn-danger btn-xs vendor-delete"><i class="fa fa-close"></i> Delete </a></td>
                        </td>
                    </tr>
