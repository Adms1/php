            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                  ...
                  <?php echo Form::open(['route'=>['bookset_update', $bookset->book_set_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'bookset-form', 'enctype'=>'multipart/form-data']); ?>
                  ...
                  <div id="bookset_tab_content" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="bookset_info" aria-labelledby="bookset_info_tab">
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('book_set_name', $bookset->book_set_name, ['class'=>'form-control', 'placeholder'=>'Enter Bookset Name', 'required'=>'required']); ?>

                            <span class="text-danger"><?php echo e($errors->first('book_set_name')); ?></span>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 select_category_css">
                            <label for="board_id">Board</label>
                            <?php echo Form::select('board_id', $boards, $bookset->board_id, ['class'=>'form-control', 'id' => 'board_id', 'required'=>'required', 'data-parsley-errors-container' => '#board_is_error']); ?>

                            <span id="board_is_error" class="text-danger"><?php echo e($errors->first('board_id')); ?></span>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 select_category_css" id="std_list">
                            <label for="standard_id">Standard</label>
                            <?php echo Form::select('standard_id', $standards, $bookset->standard_id, ['class'=>'form-control', 'id' => 'standard_id', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 select_category_css" id="sbj_list">
                            ...
                            <?php echo Form::select('subject_id[]', $subjects, $bookset->subject_id, ['class'=>'form-control', 'id' => 'subject_id', 'multiple'=>'multiple', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::text('description[]', $bookset->description[0], ['class'=>'form-control', 'placeholder'=>'Enter Single Description', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::textarea('description[]', $bookset->description[1], ['class'=>'form-control']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php echo Form::checkbox('is_active', old('is_active'), ($bookset->is_active == 1) ? true : false, ['class'=>'js-switch', 'id'=>'is_active']); ?>
                        ...
                        <tbody>
                          <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                              <td><input type="checkbox" name="book_ids[]" value="<?php echo e($product->institution_book_vendor_id); ?>" <?php echo e(in_array($product->institution_book_vendor_id, $bookset->book_ids) ? "checked" : ""); ?> id="check-all" class="flat"></td>
                              <td><img class="width-70" src="<?php echo e(URL::asset('/'.Config::get('settings.THUMBNAIL_PRODUCT_IMG_PATH').$product->book_image_path)); ?>"></td>
                              <td><a target="_blank" href="<?php echo e(route('product_detail', [$product->institution_book_vendor_id, $product->book->standard[0]->standard_id])); ?>" class="tabel_link"><?php echo e($product->book->book_name); ?></a></td>
                              <td><?php echo e($product->vendor->vendor_name); ?></td>
                              <td><?php echo e($product->book->board[0]->board_name); ?></td>
                              <td><?php echo e($product->book->standard[0]->standard_name); ?></td>
                              <td><?php echo e($product->book->subject->subject_name); ?></td>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="bookset_images" aria-labelledby="bookset_images_tab">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php echo Form::file('book_set_primary_image', ['id'=>'book_set_primary_image', 'onchange' => 'handleFileSelect()']); ?>

                            <span class="text-danger"><?php echo e($errors->first('book_set_primary_image')); ?></span>
                      ...
                      <div class="form-group">
                        ...
                        <output id="result">
                          ...
                          <?php echo e(URL::asset('/'.Config::get('settings.THUMBNAIL_BOOKSET_IMG_PATH').$bookset->primary_image)); ?>">
                        <output/>
                      </div>
                      <div class="form-group">
                ...
                <br />
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <button class="btn btn-primary" type="button" onclick="window.location='<?php echo e(route("bookset_list")); ?>'">Cancel</button>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('body').on('change', '#board_id', function(){
        ...
        $.ajax({
          url:"<?php echo e(route('standard_ajaxget')); ?>",
          type:'POST',
          dataType:'json',
      ...
      $('body').on('change', '#standard_id', function(){
        ...
        $.ajax({
          url:"<?php echo e(route('subject_ajaxget')); ?>",
          type:'POST',
          dataType:'json',
    ...
    var manualuploader = new qq.FineUploader({
        ...
        request: {
          endpoint: '<?php echo e(route("bookset_update", $bookset->book_set_id)); ?>',
        ...
        deleteFile: {
          ...
          forceConfirm: true,
          params: {'_token': csrf_token},
          endpoint: '<?php echo e(route("bookset_deleteImage", $bookset->book_set_id)); ?>'
        },
        session: {
          endpoint: '<?php echo e(route("bookset_getImage", $bookset->book_set_id)); ?>',
