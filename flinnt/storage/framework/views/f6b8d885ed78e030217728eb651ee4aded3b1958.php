          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php echo Form::open(['route' => ["updateprofile"], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'vendor-form']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="vendor_gst_number">GST Number <span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="vendor_address">Address1 <span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <label for="vendor_state_id">State <span class="required">*</span></label>
                      <?php echo Form::select('vendor_state_id',$states, $vendor->vendor_state_id, ['class'=>'form-control', 'id'=>'vendor_state_id', 'required'=>'required']); ?>

                      <span class="text-danger"><?php echo e($errors->first('vendor_state_id')); ?></span>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="vendor_pin">Pin Code <span class="required">*</span></label>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="vendor_country_id">Country <span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <label for="vendor_phone">Phone Number<span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <button class="btn btn-primary" type="button" onclick="window.location='<?php echo e(route("home")); ?>'">Cancel</button>
