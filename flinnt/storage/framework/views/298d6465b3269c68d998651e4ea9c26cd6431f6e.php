          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <?php echo Form::open(['route'=> ["attribute_update", $attribute->attribute_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'attribute-form']); ?>

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="attribute_type">Attribute Name</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php echo Form::text('attribute_name', $attribute->attribute_name, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter attribute name', 'required'=>'required']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <?php echo Form::radio('product_type','book', $attribute->product_type == 'book', ['class' => 'flat']); ?>

                      <label class="form-label" >&nbsp; Book &nbsp;</label>
                      <!-- <label class="form-label">&nbsp; Other &nbsp;</label>
                      <?php echo Form::radio('product_type','other', $attribute->product_type == 'other'); ?> -->
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
