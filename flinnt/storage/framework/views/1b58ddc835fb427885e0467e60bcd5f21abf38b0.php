            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                  ...
                  <?php echo Form::open(['route'=>'bookset_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'bookset-form']); ?>
                    ...
                    <div role="tabpanel" class="tab-pane fade active in" id="bookset_info" aria-labelledby="bookset_info_tab">
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::text('book_set_name', old('book_set_name'), ['class'=>'form-control', 'placeholder'=>'Enter Bookset Name', 'required'=>'required']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php echo Form::select('board_id', $boards, null, ['class'=>'form-control', 'id' => 'board_id', 'required'=>'required', 'data-parsley-errors-container' => '#board_id_error']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12" id="std_list">
                            ...
                            <?php echo Form::select('standard_id', [], null, ['class'=>'form-control', 'id' => 'standard_id', 'required'=>'required', 'data-parsley-errors-container' => '#standard_id_error']); ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12" id="sbj_list">
                            ...
                            <?php echo Form::select('subject_id[]', [], null, ['class'=>'form-control', 'id' => 'subject_id', 'multiple'=>'multiple', 'data-parsley-errors-container' => '#subject_id_error']); ?>

                            <span id="subject_id_error" class="text-danger"><?php echo e($errors->first('subject_id')); ?></span>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
