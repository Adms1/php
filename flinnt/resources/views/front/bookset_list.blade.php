                ...
                <div class="col-sm-12 col-md-12 col-lg-10 p-b-50">
                    ...
                    <div class="row pos-relative">
                        ...
                        <p class="width-100 white-color border-std-name m-b-20">
                            <span class="span-std-name">{{$booksets[0]->standard_name}}</span>
                            <a href="{{route('bookset_grade_list', $main_standard)}}"><span class="see-more">{{'see more'}}</span></a></p>
                        ...
                        <div class="col-sm-12 col-md-2 col-lg-2 p-b-30">
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative block-center">
                                    <a href="{{route('bookset_detail', [$bookset->institution_book_set_vendor_id, $bookset->standard_id])}}"><img src="{{URL::asset('/'.Config::get('settings.THUMBNAIL_BOOKSET_IMG_PATH').$bookset->book_set_image_path)}}" alt="IMG-PRODUCT" class="product-thumbnail"></a>
                                    ...
                                    <div class="block2-overlay trans-0-4">
                                        ...
                                        <div class="block2-btn-addcart w-size1 trans-0-4">
                                            @if (Auth::guard('user')->check())
                                                ...
                                                {!! csrf_field() !!}
                                                <input type="hidden" name="id" value="{{ $bookset->institution_book_set_vendor_id }}">
                                                <input type="hidden" name="name" value="{{ $bookset->book_set_name }}">
                                                <input type="hidden" name="book_id" value="{{ $bookset->book_set_id }}">
                                                <input type="hidden" name="price" value="{{ $bookset->sale_price }}">
                                ...
                                <div class="block2-txt p-t-20">
                                    <a href="{{route('bookset_detail', [$bookset->institution_book_set_vendor_id, $bookset->standard_id])}}" class="block2-name dis-block s-text3 p-b-5 pr-title flinnt-color">
                                        {{$bookset->book_set_name}}
                                    </a>

                                    <span class="block2-newprice m-text8 p-r-5">
                                        <i class="fa fa-rupee flinnt-price-clr"></i> 
                                        <b>{{$bookset->sale_price}}</b>
                                    </span>
                                    @if ($bookset->sale_price != $bookset->list_price)
                                    <span class="block2-oldprice m-text7 p-r-5">
                                        <i class="fa fa-rupee"></i> {{$bookset->list_price}}
                                    </span>
                                    @endif
                        ...
                        <div class="row pos-relative">
                            <p class="width-100 white-color border-std-name m-b-20">
                            <span class="span-std-name">{{$bookset->standard_name}}</span><a href="{{route('bookset_grade_list', $main_standard)}}"><span class="see-more">{{'see more'}}</span></a></p>
                            <div class="col-sm-12 col-md-2 col-lg-2 p-b-30">
                                <div class="block2">
                                    <div class="block2-img wrap-pic-w of-hidden pos-relative block-center">
                                        <a href="{{route('bookset_detail', [$bookset->institution_book_set_vendor_id, $bookset->standard_id])}}"><img src="{{URL::asset('/'.Config::get('settings.THUMBNAIL_BOOKSET_IMG_PATH').$bookset->book_set_image_path)}}" alt="IMG-PRODUCT" class="product-thumbnail"></a>
                                    ...
                                    <div class="block2-txt p-t-20">
                                        ...
                                        <span class="block2-newprice m-text8 p-r-5">
                                            <i class="fa fa-rupee flinnt-price-clr"></i> <b>{{$bookset->sale_price}}</b>
                                        </span>
                                        @if ($bookset->sale_price != $bookset->list_price)
                                        <span class="block2-oldprice m-text7 p-r-5">
                                            <i class="fa fa-rupee"></i> {{$bookset->list_price}}
