            ...
            <div class="x_panel">
              ...
              <div class="x_content">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                  ...
                  {!! Form::open(['route'=>'product_store', 'class' =>'demo-form form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'product-form', 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane fade in form-section" id="product_info" aria-labelledby="product_info_tab">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            {!! Form::text('name', old('name'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Product Name', 'required'=>'required']) !!}
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                              ...
                              {!! Form::select('publisher_id', $publishers, null, ['class'=>'form-control', 'required'=>'required', 'id' =>'publisher_id','data-parsley-errors-container' => '#publisher_id_error']) !!}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            {!! Form::select('author_id[]', $authors, null, ['class'=>'form-control', 'required'=>'required', 'id' => 'author_id', 'multiple', 'data-parsley-errors-container' => '#author_id_error']) !!}
                            <span id="author_id_error" class="text-danger">{{ $errors->first('author_id') }}</span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            <label for="name">Year <span class="required">*</span></label>
                            {!! Form::text('year', old('year'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter Edition year', 'required'=>'required']) !!}
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            ...
                            {!! Form::text('isbn', old('isbn'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter ISBN Number', 'required'=>'required']) !!}
                            <span class="text-danger">{{ $errors->first('isbn') }}</span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 product_book">
                            <label for="name">Paper Back <span class="required">*</span></label>
                            {!! Form::select('format',$formats, null, ['class'=>'form-control', 'required'=>'required']) !!}
                      ...
                      <div class="form-group product_book">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          {!! Form::checkbox('is_academic', old('is_academic'), true, ['class'=>'js-switch', 'id'=>'is_academic', 'checked']) !!}
                        </div>
                      </div>
                      <div class="form-group product_book academic">
                        <div class="form-group">
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              ...
                              {!! Form::select('board_id[]', $board, null, ['class'=>'form-control academic_book col-md-7 col-xs-12', 'multiple'=>'multiple', 'id' => 'board_id', 'required'=>'required', 'data-parsley-errors-container' => '#board_id_error']) !!}
                              <span id="board_id_error" class="text-danger">{{ $errors->first('board_id') }}</span>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              <label for="standard_id">Standard</label>
                              {!! Form::select('standard_id[]',$class, null, ['class'=>'form-control academic_book', 'multiple'=>'multiple', 'id' => 'standard_id', 'required'=>'required', 'data-parsley-errors-container' => '#standard_id_error']) !!}
                              <span id="standard_id_error" class="text-danger">{{ $errors->first('standard_id') }}</span>
                          </div>
                          <div class="col-md-4 col-sm-4 col-xs-12 product_book">
                              <label for="subject_id">Subject</label>
                              {!! Form::select('subject_id', $subject, null, ['class'=>'form-control academic_book col-md-7 col-xs-12', 'id' => 'subject_id', 'required'=>'required']) !!}
                      ...
                      <div class="form-group">
                        <div class="col-md4 col-sm-4 col-xs-12">
                            ...
                            {!! Form::number('list_price', old('list_price'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter List Price', 'required'=>'required']) !!}
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            {!! Form::number('display_price', old('display_price'), ['class'=>'form-control', 'placeholder'=>'Enter Display Price', 'required'=>'required']) !!}
                            <span class="text-danger">{{ $errors->first('language_id') }}</span>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          {!! Form::text('hs_code', old('for="hs_code'), ['class'=>'form-control', 'required'=>'required', 'placeholder' => 'Enter Code']) !!}
                    ...
                    <div role="tabpanel" class="tab-pane fade in form-section" id="product_categories_info" aria-labelledby="product_categories_info_tab">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" id="select_category_css">
                            {!! Form::select('category_id[]', $categories, null, ['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'id'=>'category_id', 'multiple'=>'multiple','data-parsley-errors-container' => '#category_id_error']) !!}
...
<!--                         <div class="form-group">
                    ...
                    <!-- <div role="tabpanel" class="tab-pane fade" id="product_attribute_info" aria-labelledby="product_attribute_info_tab">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          {!! Form::select('sp_attribute_id', $sp_attributes, null, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Select Attribute', 'id'=>'sp_attribute_id']) !!}
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          {!! Form::text('sp_attribute_val', old('sp_attribute_val'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter attribute value', 'id'=>'sp_attribute_val']) !!}
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                    ...
                    <!-- <div role="tabpanel" class="tab-pane fade" id="product_tag" aria-labelledby="product_tag_tab">
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <label>Tags</label>
                          {!! Form::text('tag', 'social, adverts', ['id' => 'tags', 'class'=>'tags form-control', 'placeholder'=>'Enter Tag Name']) !!}
                      ...
                      <table id="tabel_sp_atr" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                        ...
                        <tbody class="sp_atr row_position">
                          <tr class="mul_div">
                            ...
                            <td>M, S</td>
                            <td>659</td>
                            <td><img style="width: 20%" src="{{URL::asset('/images/tshirt.jpg')}}"></td>
                            <td>
                              <a class="btn btn-danger remove_this">Delete</a>
                            </td>
                          </tr>
                          ...
                          <tr class="mul_div">
                            ...
                            <td>32 inches</td>
                            <td>11999</td>
                            <td><img style="width: 20%" src="{{URL::asset('/images/tt.jpg')}}"></td>
                            <td>
                              <a class="btn btn-danger remove_this">Delete</a>
                            </td>
                          </tr>
                          ...
                          <tr class="mul_div">
                            ...
                            <td>M, S</td>
                            <td>659</td>
                            <td><img style="width: 20%" src="{{URL::asset('/images/shirt.jpg')}}"></td>
                            <td>
                              <a class="btn btn-danger remove_this">Delete</a>
                            </td>
                          </tr>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      /*$('#author_id').select2({
        ...
        //                       <td>\
        //                         {!! Form::hidden("sp_attr_id", '+sp_attr_key+') !!}\
        //                         '+sp_attr_text+'\
        //                       </td>\
        //                       <td>\
        //                         '+sp_attr_val+'\
