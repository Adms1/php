                ...
                <div class="x_content">
                  <br />
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <button class="btn btn-info float-right" onclick="window.location='{{ route("boards") }}'">Add Board</button>
                    </div>
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $i++ }}</td>
                        <td><a href='{{ route("board_edit", [$board->board_id])}}' class="tabel_link">{{$board->board_name}}</a></td>
                        <td>
                          <a href='{{ route("board_destroy", [$board->board_id])}}' class="btn btn-danger btn-xs board-delete"><i class="fa fa-close"></i> Delete </a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
