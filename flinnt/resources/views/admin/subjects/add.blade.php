          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['route'=>'subject_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'subject-form']) !!}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="attribute_type">Subject Name</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('subject_name', old('subject_name'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter subject name', 'required'=>'required']) !!}
