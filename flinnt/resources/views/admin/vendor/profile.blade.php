          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['route' => ["updateprofile"], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'vendor-form']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      {!! Form::select('vendor_state_id',$states, $vendor->vendor_state_id, ['class'=>'form-control', 'id'=>'vendor_state_id', 'required'=>'required']) !!}
                      <span class="text-danger">{{ $errors->first('vendor_state_id') }}</span>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
