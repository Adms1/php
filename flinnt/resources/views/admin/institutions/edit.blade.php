          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['route'=> ["institution_update", $institution->institution_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'institution-form', 'enctype'=>'multipart/form-data']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        {!! Form::select('status_id',$status, $institution->status_id, ['class'=>'form-control', 'placeholder'=>'Select status', 'required'=>'required']) !!}
