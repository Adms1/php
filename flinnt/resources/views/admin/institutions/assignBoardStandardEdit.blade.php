          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                @endif
                {!! Form::open(['route'=> ["institution_boardstandard_update", $board_id, $standard_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'institution-form']) !!}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="board_id">Board</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::select('board_id',$board, $board_id, ['class'=>'form-control', 'id' => 'board_id',  'required'=>'required', 'disabled']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::select('standard_id[]',$class, $standard_id, ['class'=>'form-control', 'id' => 'standard_id', 'required'=>'required', 'multiple', 'disabled']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::select('subject_id[]',$subject, $assign_subjects, ['class'=>'form-control', 'id' => 'subject_id', 'required'=>'required', 'multiple']) !!}
