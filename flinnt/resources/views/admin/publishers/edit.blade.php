          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['route'=> ["publisher_update", $publisher->publisher_id], 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'publisher-form']) !!}
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('publisher_name', $publisher->publisher_name, ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter publisher name', 'required'=>'required']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      {!! Form::textarea('description', $publisher->description, ['class'=>'form-control', 'placeholder'=>'Enter Description']) !!}
