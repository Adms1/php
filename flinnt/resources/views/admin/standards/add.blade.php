          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::open(['route'=>'standard_store', 'class' =>'form-horizontal form-label-left', 'data-parsley-validate', 'id'=>'standard-form']) !!}
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="attribute_type">Standard Name</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('standard_name', old('standard_name'), ['class'=>'form-control col-md-7 col-xs-12', 'placeholder'=>'Enter standard name', 'required'=>'required']) !!}
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      {!! Form::textarea('about_standard', old('about_standard'), ['class'=>'form-control', 'placeholder'=>'About Standard', 'required'=>'required']) !!}
